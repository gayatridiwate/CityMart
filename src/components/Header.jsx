...
import { MdShoppingBasket, MdAdd, MdLogout, MdDelete } from "react-icons/md";
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "gayatridivate5000@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p
        ...
        <div className="relative">
          ...
          {isMenu && (
            <motion.div
              ...
              className="w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0"
            >
              {user && user.email === "gayatridivate5000gmail.com" && (
                <Link to={"/createItem"}>
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center 
